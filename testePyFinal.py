...
def index():
    return render_template_string('''
        ...
        <head>
            ...
            <style>
                ...
                .label {
                    font-size: 18px;
                    font-weight: bold;
                    margin-bottom: 10px; /* Espaço entre o texto e o termômetro */
                }
            </style>
            <script>
        ...
        <body>
            <div class="title">
                <h1>Tópicos Interface - Projeto Final</h1>
                <h2>Alunos: Hudson Taylor e Everton</h2>
                <br><br>
            </div>
            <div class="container">
                <div class="thermometer-wrapper">
                    <div class="label">Termômetro 26</div>
                ...
                <div class="thermometer-wrapper">
                    <div class="label">Termômetro 42</div>
                    <div class="thermometer">
